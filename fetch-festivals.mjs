 ...
 *  5) 네이버 블로그 검색 (총 검색결과 수)                        → 인기도(언급량) 추정, 상위 항목에 🔥 배지
 *
 ...
 *
 * 다섯 개 중 일부만 있어도 동작합니다 (없는 소스는 건너뜀).
 */
...
const sourceStatus = { tourapi: true, culture: true, kopis: true, weather: true, mentions: true };
